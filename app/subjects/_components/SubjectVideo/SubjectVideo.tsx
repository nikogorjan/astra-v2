...
export type SubjectVideoProps = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;

export const SubjectVideo = (props: SubjectVideoProps) => {
  const { image, video } = {
    ...SubjectVideoDefaults,
    ...props,
  } as Props;
  ...
  return (
    <section id="relume" className="px-[5%] py-8 md:py-18">
...
export const SubjectVideoDefaults: SubjectVideoProps = {
  heading: "99,4%",
  description:
...
SubjectVideo.displayName = "SubjectVideo";
