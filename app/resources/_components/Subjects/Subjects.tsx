...
type Props = {
  heading: string;
  Subjects: SchoolProps[];
  inputPlaceholder?: string;
  inputIcon: InputProps;
};

export type SubjectsProps = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;

export const Subjects = (props: SubjectsProps) => {
  const { Subjects, inputPlaceholder, inputIcon } = {
    ...SubjectsDefaults,
    ...props,
  } as Props;
...
export const SubjectsDefaults: SubjectsProps = {
  heading: "List of video explenation Subjects",
